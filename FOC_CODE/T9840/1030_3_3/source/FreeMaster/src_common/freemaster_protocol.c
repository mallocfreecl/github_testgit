...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Decodes the FreeMASTER
                                                                              *protocol and calls appropriate handlers
                                                                              *
                                                                              * @param    pMessageIO - message in/out
                                                                              *buffer
                                                                              *
                                                                              * @return   TRUE if frame was valid and
                                                                              *any output was generated to IO buffer
                                                                              *
                                                                              * This Function decodes given message and
                                                                              *invokes proper command handler which
                                                                              *fills in the response. The response
                                                                              *transmission is initiated in this call as
                                                                              *well.
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              ...
                                                                              *
                                                                              * @param    pMessageIO - outut frame
                                                                              *buffer
                                                                              *
                                                                              * @return   True if successful (always in
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Handling READVAR and
                                                                              *READVAR_EX commands (for all sizes 1,2,4)
                                                                              *
                                                                              * @param    pMessageIO - original command
                                                                              *(in) and response buffer (out)
                                                                              *
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Handling WRITEMEM and
                                                                              *WRITEMEM_EX commands
                                                                              *
                                                                              * @param    pMessageIO - original command
                                                                              *(in) and response buffer (out)
                                                                              *
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Handling WRITEMEMMASK and
                                                                              *WRITEMEMMASK_EX commands
                                                                              *
                                                                              * @param    pMessageIO - original command
                                                                              *(in) and response buffer (out)
                                                                              *
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Private inline implementation
                                                                              *of "strlen" used by TSA and Pipes
                                                                              *
                                                                              ******************************************************************************/
