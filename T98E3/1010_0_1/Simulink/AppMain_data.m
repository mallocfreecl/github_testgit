...
CtrlConst.SpeedCtrl.PwmIn.Duty.Filter.DutyTolerance=uint16(20); % 20*0.1%=2% 误差
CtrlConst.SpeedCtrl.PwmIn.Duty.Filter.DutySameCntTHR = uint16(4);%在误差范围内的数值如果存在4个则认为值是有效的

CtrlConst.SpeedCtrl.PwmIn.TargetSpeed = struct;
CtrlConst.SpeedCtrl.PwmIn.TargetSpeed.Min = int16(1020);%rpm
CtrlConst.SpeedCtrl.PwmIn.TargetSpeed.Max = int16(5100);%rpm
...
CtrlConst.FaultDiag.AmbTemperature.PreOverFilterTime = uint16(1/5e-3);
