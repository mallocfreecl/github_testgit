...
#ifndef FREEMASTER_TSA_H
#define FREEMASTER_TSA_H
...
#define FMSTR_TSATBL_STRPTR_ENTRY(x)                                                                                   \
  {                                                                                                                    \
    FMSTR_TSATBL_STRPTR_CAST(x)                                                                                        \
  }
#endif
...
#define FMSTR_TSATBL_VOIDPTR_ENTRY(x)                                                                                  \
  {                                                                                                                    \
    FMSTR_TSATBL_VOIDPTR_CAST(x)                                                                                       \
  }
#endif
...
#define FMSTR_TSA_STRUCT_CFG(name)                                                                                     \
  FMSTR_TSATBL_STRPTR_ENTRY(#name), FMSTR_TSATBL_STRPTR_ENTRY(NULL), FMSTR_TSATBL_VOIDPTR_ENTRY(NULL),                 \
    FMSTR_TSATBL_VOIDPTR_ENTRY(FMSTR_TSA_INFO1(name, FMSTR_TSA_INFO_STRUCT)),
...
#define FMSTR_TSA_MEMBER_CFG(parenttype, name, type)                                                                   \
  FMSTR_TSATBL_STRPTR_ENTRY(#name), FMSTR_TSATBL_STRPTR_ENTRY(type),                                                   \
    ...
    FMSTR_TSATBL_VOIDPTR_ENTRY(FMSTR_TSA_INFO1(((parenttype *)0)->name, FMSTR_TSA_INFO_MEMBER)),
...
#define FMSTR_TSA_STRUCT(name) {FMSTR_TSA_STRUCT_CFG(name)},
...
#define FMSTR_TSA_DIRECTORY(dirname) {FMSTR_TSA_RO_ENTRY(dirname, FMSTR_TSA_SPECIAL ":DIR", NULL, 0)},
...
#define FMSTR_TSA_TABLE_END()                                                                                          \
  ...
  ;                                                                                                                    \
  if (pTableSize)                                                                                                      \
    *pTableSize = sizeof(fmstr_tsatable);                                                                              \
