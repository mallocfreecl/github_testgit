...
/* Disable freemaster, 21.07.30 by yhd */
...
#define FMSTR_SCI_BASE BASE_ADDR_SCI //!< SCI base will be assigned in runtime (when FMSTR_USE_SCI)
// #undef FMSTR_CAN_BASE   //!< CAN base will be assigned in runtime (when FMSTR_USE_FLEXCAN)

#define FMSTR_SCI_STATUS_W1C 0
...
#define FMSTR_USE_APPCMD 0        // FMSTR_DEMO_ENOUGH_ROM  //!< Enable/disable App.Commands support
