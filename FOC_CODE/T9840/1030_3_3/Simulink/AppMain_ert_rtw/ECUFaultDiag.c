  ...
  else
  {
    switch (localDW->is_c2_lib1)
    {
     ...
     case IN_High_fhmx:
      ...
      {
        UpdateStateCnt_hvit(150, 319, rtu_Voltage, localDW);
      }
      break;
     ...
     case IN_Low_lcjb:
      ...
      {
        UpdateStateCnt_hvit(158, 362, rtu_Voltage, localDW);
      }
      break;
     ...
     default:
      ...
      {
        UpdateStateCnt_hvit(150, 362, rtu_Voltage, localDW);
      }
      break;
    }
  }
