...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    The "memcpy" used internally
                                                                              *in FreeMASTER driver
                                                                              *
                                                                              * @param    nDestAddr - destination memory
                                                                              *address
                                                                              * @param    nSrcAddr  - source memory
                                                                              *address
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Write-into the communication
                                                                              *buffer memory
                                                                              *
                                                                              * @param  pDestBuff - pointer to
                                                                              *destination memory in communication
                                                                              *buffer
                                                                              * @param  nSrcAddr  - source memory
                                                                              *address
                                                                              * @param  nSize     - buffer size (always
                                                                              *in bytes)
                                                                              *
                                                                              * @return This function returns a pointer
                                                                              *to next byte in comm. buffer
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Read-out memory from
                                                                              *communication buffer
                                                                              *
                                                                              * @param  nDestAddr - destination memory
                                                                              *address
                                                                              * @param  pSrcBuff  - pointer to source
                                                                              *memory in communication buffer
                                                                              * @param  nSize     - buffer size (always
                                                                              *in bytes)
                                                                              *
                                                                              * @return This function returns a pointer
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Read-out memory from
                                                                              *communication buffer, perform AND-masking
                                                                              *
                                                                              * @param  nDestAddr - destination memory
                                                                              *address
                                                                              * @param  pSrcBuff  - source memory in
                                                                              *communication buffer, mask follows data
                                                                              * @param  nSize     - buffer size (always
                                                                              *in bytes)
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  When mixed EX and no-EX command
                                                                              *may occur, this variable is here to
                                                                              *remember what command is just being
                                                                              *handled.
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Store address to communication
                                                                              *buffer. The address may be 32 or 16 bit
                                                                              *wide (based on previous call to
                                                                              *FMSTR_SetExAddr)
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Fetch address from communication
                                                                              *buffer
                                                                              *
                                                                              ******************************************************************************/
