...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Handling SFIOFRAME (even and
                                                                              *odd) commands
                                                                              *
                                                                              * @param  pMessageIO - original command
                                                                              *(in) and response buffer (out)
                                                                              *
                                                                              * @note  This function handles the SFIO
                                                                              *(Matlab/Simulink Interface) command
                                                                              *        encapsulated into FreeMASTER
                                                                              *protocol. It emulates the SFIO serial
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Handling SFIOGETRESP (even and
                                                                              *odd) commands
                                                                              *
                                                                              * @param  pMessageIO - original command
                                                                              *(in) and response buffer (out)
                                                                              *
                                                                              * @note  This function handles the retried
                                                                              *request for the last SFIO response. PC
                                                                              *may request this retry when the last
                                                                              *frame execution took too long (e.g. due
                                                                              *to breakpoint) but is still finished
                                                                              *properly. The original SFIOFRAME command
                                                                              *returned timeout, so the PC will use
                                                                              *SFIOGETRESP to finish data.
                                                                              *
                                                                              *        The even/odd matching is here to
                                                                              *have some dgree of robustness for a case
                                                                              *when SFIOFRAME packet gets lost without
                                                                              *ever reaching SFIO engine. Without any
                                                                              *checking, the SFIOGETRESP would just
                                                                              *blindly return the pre-last result and
                                                                              *would definietelly cause Simulink
                                                                              *problems. Having the check implemented,
                                                                              *the PC can determine the even/odd
                                                                              *mismatch and may re-send the last
                                                                              *SFIOFRAME command.
                                                                              *
                                                                              ******************************************************************************/
