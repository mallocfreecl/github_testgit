 ...
 * @retval      无
 */
void dac_init(void)//dac1两个通道初始化
{
    ...
    gpio_init_struct.Pin = GPIO_PIN_4|GPIO_PIN_5;               /* STM32单片机, 总是PA4=DAC1_OUT1, PA5=DAC1_OUT2 */
...
/**
 * @brief       设置通道1/2输出电压
                主函数没用，该函数可直接通过HAL_DAC_SetValue对值进行调整,调试时可使用USMART对值进行设置
