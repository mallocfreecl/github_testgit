...
#if defined(FMSTR_PLATFORM_E52352)
#if FMSTR_PLATFORM_E52352
#include "freemaster_e52352.h"
#define FMSTR_PLATFORM E52352
#else
#undef FMSTR_PLATFORM_E52352
#endif
#endif
...
#define FMSTR_COUNT_INTERFACES                                                                                         \
  (((FMSTR_DISABLE) ? 1 : 0) + ((FMSTR_USE_SCI) ? 1 : 0) + ((FMSTR_USE_ESCI) ? 1 : 0) + ((FMSTR_USE_LPUART) ? 1 : 0) + \
   ((FMSTR_USE_PDBDM) ? 1 : 0) + ((FMSTR_USE_JTAG) ? 1 : 0) + ((FMSTR_USE_CAN) ? 1 : 0) +                              \
   ((FMSTR_USE_LINTL) ? 1 : 0) + ((FMSTR_USE_MQX_IO) ? 1 : 0) + ((FMSTR_USE_USB_CDC) ? 1 : 0) +                        \
   ((FMSTR_USE_MBED) ? 1 : 0))
...
/* can't be a few */
#if ((((FMSTR_USE_MSCAN) ? 1 : 0) + ((FMSTR_USE_FLEXCAN) ? 1 : 0) + ((FMSTR_USE_FLEXCAN32) ? 1 : 0) +                  \
      ((FMSTR_USE_MCAN) ? 1 : 0)) > 1)
...
#warning                                                                                                               \
  "MQX IO interface doesn't supports the normal Short Interrupt routines, please open your MQX communication interface in Interrupt mode"
#endif
#endif
...
#if (FMSTR_USE_SCI) || (FMSTR_USE_ESCI) || (FMSTR_USE_LPUART) || (FMSTR_USE_JTAG) || (FMSTR_USE_USB_CDC) ||            \
  (FMSTR_USE_MQX_IO) || (FMSTR_USE_MBED)
...
#warning                                                                                                               \
  "FreeMASTER Packet Driven BDM driver doesn't support any Interrupt mode. Call the FMSTR_Poll() function in the Timer ISR routine instead."
#endif
#endif
