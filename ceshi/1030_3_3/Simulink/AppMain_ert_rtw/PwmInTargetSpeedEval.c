  ...
  uint16_T *rty_samecnt)
{
  ...
  *rty_samecnt = 1U;
  ...
  {
    uint16_T rtu_buf_0;
    rtu_buf_0 = rtu_buf[(int16_T)(i + 1)];
    if ((rtu_buf_0 >= b_min) && (rtu_buf_0 <= b_max))
    {
      /* (':2285:1:15') */
      /* (':2285:1:16') */
      rtu_buf_0 = (uint16_T)(*rty_samecnt + 1U);
      if ((uint16_T)(*rty_samecnt + 1U) < *rty_samecnt)
      {
        rtu_buf_0 = MAX_uint16_T;
      }

      *rty_samecnt = rtu_buf_0;
    }
  }
}
                ...
                boolean_T *rty_Reset, uint16_T *rty_SectorNew)
{
  *rty_SectorNew = rtu_SectorLast;
  ...
  else if (rtu_Duty <= 900U)
  {
    ...
    z = (uint32_T)(qY / 350UL);
    if ((uint32_T)(qY - (uint32_T)(z * 350UL)) >= 175UL)
    {
      z++;
    }
...
void PwmInSpeedCtrl(void)
{
  ...
  switch (rtAction)
  {
   case 0:
    ...
    else
    {
      ...
      if (Y.PwmInShortBat)
      {
        ...
        rtb_Speed = (int16_T)(int32_T)asr_s32((int32_T)(375L * (int32_T)
          look1_is16lu32n16Ds32_binlcs(U.FilteredVoltage, ConstP.pooled7,
          ConstP.pooled6, 2UL)), 4U);
   ...
   case 1:
     ...
     */
    SpeedCurve((int32_T)asr_s32((int32_T)(375L * (int32_T)
      look1_is16lu32n16Ds32_binlcs(U.FilteredVoltage, ConstP.pooled7,
      ConstP.pooled6, 2UL)), 4U), 3100, B.Duty, DW.LastState_PreviousInput,
