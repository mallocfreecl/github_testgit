...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    API: Replacing the recorder
                                                                              *buffer with the user's one
                                                                              *
                                                                              * @param    pBuffer - user buffer pointer
                                                                              * @param    wBuffSize - buffer size
                                                                              *
                                                                              * @note Use the FMSTR_SetUpBuff32 to pass
                                                                              *the forced 32bit address in SDM
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Handling SETUPREC and
                                                                              *SETUPREC_EX commands
                                                                              *
                                                                              * @param    pMessageIO - original command
                                                                              *(in) and response buffer (out)
                                                                              *
                                                                              * @return   As all command handlers, the
                                                                              *return value should be the buffer pointer
                                                                              *where the response output finished
                                                                              *(except checksum)
                                                                              *
                                                                              ******************************************************************************/
...
#if FMSTR_CFG_BUS_WIDTH == 1U
      case 1:
        pcm_pCompareFunc = pcm_bTrgVarSigned ? FMSTR_Compare8S : FMSTR_Compare8U;
        break;
#endif
      case 2:
        pcm_pCompareFunc = pcm_bTrgVarSigned ? FMSTR_Compare16S : FMSTR_Compare16U;
        break;
      case 4:
        pcm_pCompareFunc = pcm_bTrgVarSigned ? FMSTR_Compare32S : FMSTR_Compare32U;
        break;
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    API: Pull the trigger of the
                                                                              *recorder
                                                                              *
                                                                              * This function starts the post-trigger
                                                                              *stop countdown
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              ...
                                                                              *
                                                                              * @return   As all command handlers, the
                                                                              *return value should be the length of the
                                                                              *response filled into the buffer
                                                                              *(including status byte)
                                                                              *
                                                                              * This function starts recording
                                                                              *(initializes internal recording variables
                                                                              * and flags)
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              ...
                                                                              *(including status byte)
                                                                              *
                                                                              * This function stops recording (same as
                                                                              *manual trigger)
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              ...
                                                                              *(except checksum)
                                                                              *
                                                                              * This function returns current recorder
                                                                              *status
                                                                              *
                                                                              ******************************************************************************/
...
{
  FMSTR_U16 nResponseCode = (FMSTR_U16)(pcm_wRecFlags.flg.bIsRunning ? FMSTR_STS_RECRUN : FMSTR_STS_RECDONE);
...
/**************************************************************************/ /*!
                                                                              ...
                                                                              *
                                                                              * @return   Recorder memory size in native
                                                                              *sizeof units (=bytes on most platforms)
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Check wether given memory
                                                                              *region is inside the recorder buffer
                                                                              *
                                                                              * @param    dwAddr - address of the memory
                                                                              *to be checked
                                                                              * @param    wSize  - size of the memory to
                                                                              *be checked
                                                                              *
                                                                              * @return   This function returns non-zero
                                                                              *if user space is in recorder buffer
                                                                              *
                                                                              * This function is called as a part of
                                                                              *TSA-checking process when the PC host is
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Handling GETRECBUFF and
                                                                              *GETRECBUFF_EX command
                                                                              *
                                                                              * @param    pMessageIO - original command
                                                                              *(in) and response buffer (out)
                                                                              *
                                                                              ...
                                                                              *(except checksum)
                                                                              *
                                                                              * This function returns recorder buffer
                                                                              *information
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Compare macro used in trigger
                                                                              *detection
                                                                              *
                                                                              * @param    v - original command
                                                                              * @param    t - response buffer
                                                                              *
                                                                              * @return   zero when value is lower than
                                                                              *threshold.
                                                                              * @return   non-zero when value is greater
                                                                              *than or equal as threshold
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    API: Recorder worker routine -
                                                                              *can be called from application's timer
                                                                              *ISR
                                                                              *
                                                                              *
                                                                              * This returns quickly if recorder is not
                                                                              *running, otherwise it calls quite lengthy
                                                                              * recorder routine which does all the
                                                                              *recorder work (sampling, triggering)
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Recorder function called when
                                                                              *recorder is active
                                                                              *
                                                                              ******************************************************************************/
