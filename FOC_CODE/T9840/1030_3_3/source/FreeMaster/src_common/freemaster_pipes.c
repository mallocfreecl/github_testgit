...
static FMSTR_BOOL FMSTR_PipePrintfOne(FMSTR_HPIPE hpipe, const char *pszFmt, void *parg,
...
FMSTR_HPIPE FMSTR_PipeOpen(FMSTR_PIPE_PORT nPort, FMSTR_PPIPEFUNC pCallback, FMSTR_ADDR pRxBuff,
                           FMSTR_PIPE_SIZE nRxSize, FMSTR_ADDR pTxBuff, FMSTR_PIPE_SIZE nTxSize)
{
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  PIPE API: Put zero-terminated
                                                                              *string into pipe. Succeedes only if full
                                                                              *string fits into the output buffer and
                                                                              *return TRUE if so.
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Flush pipe's printf formatting
                                                                              *buffer into pipe output buffer
                                                                              *
                                                                              *****************************************************************************/
...
FMSTR_INLINE FMSTR_BOOL FMSTR_PipePrintfFlush(FMSTR_HPIPE hpipe)
{
  ...
  {
    FMSTR_SIZE8 sz =
      (FMSTR_SIZE8)FMSTR_PipeWrite(hpipe, (FMSTR_ADDR)pp->printfBuff, (FMSTR_PIPE_SIZE)pp->printfBPtr, 0);
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Put one character into pipe's
                                                                              *printf formating buffer
                                                                              *
                                                                              *****************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  This function finishes the
                                                                              *number formatting, adds spacing, signs
                                                                              *         and reverses the string (the
                                                                              *input is comming in reversed order)
                                                                              *
                                                                              *****************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  This function formats the
                                                                              *argument into the temporary printf buffer
                                                                              *         It is granted by the caller that
                                                                              *the buffer is empty before calling.
                                                                              *
                                                                              *****************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  This function parses the printf
                                                                              *format and sets the context structure
                                                                              *properly.
                                                                              *
                                                                              * @return The function returns the pointer
                                                                              *to end of format string handled
                                                                              *
                                                                              *****************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Printf with one argument passed
                                                                              *by pointer.
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  PIPE API: Format argument into
                                                                              *the pipe output stream. The format
                                                                              *         follows the standard printf
                                                                              *format. The leading '%' is optional.
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Format va_list argument into the
                                                                              *pipe output stream. This function is
                                                                              *called as a part of our printf routine.
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Printf with va_list arguments
                                                                              *prepared.
                                                                              *
                                                                              *         This function is not declared
                                                                              *static (may be reused as global), but
                                                                              *public prototype is not available (not to
                                                                              *force user to have va_list defined.
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  PIPE API: The printf into the
                                                                              *pipe
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief  Get number of bytes free in the
                                                                              *buffer
                                                                              *
                                                                              ******************************************************************************/
