...
void FeedBack(void)
{
   ...
   */
  rtb_Compare = (B.PwmInTargetSpeed != 0);
   ...
   */
  rtb_DataTypeConversion1_iufm = FeedBackDelay(0U, (int16_T)Y.VoltageStatus != 0,
    0U, &B.FeedBackDelay4, &DW.FeedBackDelay4);
  ...
  B.Switch_kva1 = ((!rtb_DataTypeConversion1_iufm) && (!rtb_DataTypeConversion1)
                   && ((!U.IsMotorShort) || (!rtb_LogicalOperator3) ||
                       (!rtb_Compare)) && ((!U.IsMotorOpenLoad) ||
    (!rtb_LogicalOperator3_ew35) || (!rtb_Compare)) && ((!U.IsMotorLock) ||
    (!rtb_LogicalOperator3_j3fr) || (!rtb_Compare)) && ((!U.IsMotorDryRunning) ||
    (!rtb_Compare)));
