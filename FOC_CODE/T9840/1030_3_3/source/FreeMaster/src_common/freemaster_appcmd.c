...
/**************************************************************************/ /*!
                                                                              ...
                                                                              *(except checksum)
                                                                              *
                                                                              * @note The callback-registered commands
                                                                              *are processed at the moment the PC tries
                                                                              *to get the result for the first time. At
                                                                              *this moment, we are sure the PC already
                                                                              *got the command delivery packet
                                                                              *acknowledged.
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Find index of registered
                                                                              *app.cmd callback
                                                                              *
                                                                              * @param    nAppcmdCode - App. command ID
                                                                              *
                                                                              * @return   Index of function pointer in
                                                                              *our local tables
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    API: Mark the application
                                                                              *command is processed by the application
                                                                              *
                                                                              * @param    nResultCode - the result code
                                                                              *which is returned to a host
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              ...
                                                                              *command is processed by the application
                                                                              *
                                                                              * @param    pResultDataAddr - address of
                                                                              *data we want to return to the PC
                                                                              * @param    nResultDataLen - length of
                                                                              *return data
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    API: Fetch the application
                                                                              *command code if one is ready for
                                                                              *processing
                                                                              *
                                                                              * @return   A command code stored in the
                                                                              *application cmd buffer. The return value
                                                                              *is FMSTR_APPCMDRESULT_NOCMD if there is
                                                                              *no new command since the last call to
                                                                              *FMSTR_AppCmdAck
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    API: Get a pointer to
                                                                              *application command data
                                                                              *
                                                                              * @param    pDataLen - A pointer to
                                                                              *variable which receives the data length
                                                                              *
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    API: Register or unregister
                                                                              *app.cmd callback handler
                                                                              *
                                                                              * @param    nAppCmdCode   - App.command ID
                                                                              * @param    pCallbackFunc - Pointer to
                                                                              *handler function (NULL to unregister)
                                                                              *
                                                                              * @return   Non-zero if successfull, zero
                                                                              *if maximum callbacks already set
                                                                              *
                                                                              ******************************************************************************/
...
FMSTR_BOOL FMSTR_RegisterAppCmdCall(FMSTR_APPCMD_CODE nAppCmdCode, FMSTR_PAPPCMDFUNC pCallbackFunc)
{
  ...
  pcm_pAppCmdCallId[nIndex] = (FMSTR_APPCMD_CODE)(pCallbackFunc ? nAppCmdCode : FMSTR_APPCMDRESULT_NOCMD);
