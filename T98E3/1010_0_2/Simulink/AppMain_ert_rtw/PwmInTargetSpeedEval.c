                ...
                *localDW)
{
  ...
  if (rtu_Enable)
  {
    ...
    if (rtu_IsPwmDutyUpdated)
    {
      ...
      for (i = 0; i < 6; i++)
      {
        rtb_RelationalOperator1[i] = ((int32_T)localB->buf[i] <= 8191);
      }
                ...
                boolean_T *rty_Reset, uint16_T *rty_SectorNew)
{
  *rty_SectorNew = rtu_SectorLast;
  ...
  if ((int32_T)rtu_Duty < 50)
  {
    /* (':1609:1:3') */
    /* (':1609:1:4') */
    *rty_Speed = 0;
  }
  else if ((int32_T)rtu_Duty < 255)
  {
    int32_T qY;
    int32_T tmp;
    uint32_T qY_0;
    ...
    /* (':1609:1:6') */
    /* (':1609:1:7') */
    qY = (int32_T)(uint32_T)((uint32_T)rtu_Duty - 50U);
    if ((uint32_T)((uint32_T)rtu_Duty - 50U) > (uint32_T)rtu_Duty)
    {
      qY = 0;
    }
    ...
    z = (uint32_T)(qY_0 / 200U);
    if ((uint32_T)(qY_0 - (uint32_T)(z * 200U)) >= 100U)
    {
      z++;
    }
    ...
    *rty_Speed = (int16_T)qY_0;
    if ((int32_T)(int16_T)qY_0 > rtu_MaxSpeed)
    {
      /* (':1609:1:11') */
      /* (':1609:1:12') */
      tmp = rtu_MaxSpeed;
...
void PwmInSpeedCtrl(void)
{
  ...
  switch (rtAction)
  {
   ...
   case 1:
     ...
     */
    SpeedCurve((int32_T)asr_s32((int32_T)(1275 * (int32_T)
      look1_is16lu32n16Ds32_binlcs(U.FilteredVoltage,
      ConstP.uDLookupTable_bp01Data, ConstP.uDLookupTable_tableData, 2U)), 6U),
               1020, B.Duty, DW.LastState_PreviousInput, &rtb_Speed,
               &rtb_PwmInTargetSpeed, &rtb_Rst, &DW.LastState_PreviousInput);
   ...
   default:
     ...
     */
    rtb_PwmInTargetSpeed = DW.LastDelay_PreviousInput;
  ...
  SpeedDelayOut(rtb_Speed, rtb_PwmInTargetSpeed, rtb_Rst, &B.Out,
  ...
  DW.LastDelay_PreviousInput = rtb_PwmInTargetSpeed;
}
