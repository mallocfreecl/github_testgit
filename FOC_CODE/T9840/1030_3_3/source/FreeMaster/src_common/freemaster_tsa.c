...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Assigning memory to dynamic
                                                                              *TSA table
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Retrieving entry from dynamic
                                                                              *TSA table
                                                                              *
                                                                              ******************************************************************************/
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Our private strcmp function,
                                                                              *simplified to return zero/nonzero only
                                                                              *
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Add entry to a dynamic TSA
                                                                              *table
                                                                              *
                                                                              ******************************************************************************/

FMSTR_BOOL FMSTR_TsaAddVar(FMSTR_TSATBL_STRPTR pszName, FMSTR_TSATBL_STRPTR pszType, FMSTR_TSATBL_VOIDPTR nAddr,
                           FMSTR_SIZE32 nSize, FMSTR_SIZE nFlags)
{
#if FMSTR_USE_TSA_DYNAMIC
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Handling GETTSAINFO and
                                                                              *GETTSAINFO_EX command
                                                                              *
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Handling GETSTRLEN and
                                                                              *GETSTRLEN_EX commands
                                                                              *
                                                                              * @param    pMessageIO - original command
                                                                              *(in) and response buffer (out)
                                                                              *
...
/**************************************************************************/ /*!
                                                                              *
                                                                              * @brief    Helper (inline) function for
                                                                              *TSA memory region check
                                                                              *
                                                                              * @param    nAddrUser - address of region
                                                                              *to be checked
                                                                              * @param    nSizeUser - size of region to
                                                                              *be checked
                                                                              * @param    nAddrSafe - address of known
                                                                              *"safe" region
                                                                              * @param    wSizeSafe - size of safe
                                                                              *region
                                                                              *
                                                                              * @return   This function returns non-zero
                                                                              *if given user space is safe (i.e. it lies
                                                                              *in given safe space)
                                                                              *
                                                                              ******************************************************************************/

/* declare function prototype */
static FMSTR_BOOL FMSTR_CheckMemSpace(FMSTR_ADDR nAddrUser, FMSTR_SIZE8 nSizeUser, FMSTR_ADDR nAddrSafe,
                                      FMSTR_SIZE wSizeSafe);
                                      ...
                                      FMSTR_SIZE wSizeSafe)
{
  ...
  {
    bRet = (FMSTR_BOOL)(((nAddrUser + nSizeUser) <= (nAddrSafe + wSizeSafe)) ? FMSTR_TRUE : FMSTR_FALSE);
  }
...
/**************************************************************************/ /*!
                                                                              ...
                                                                              *region is "safe" (covered by TSA)
                                                                              *
                                                                              * @param    dwAddr - address of the memory
                                                                              *to be checked
                                                                              * @param    nSize  - size of the memory to
                                                                              *be checked
                                                                              * @param    bWriteAccess - write access is
                                                                              *required
                                                                              *
                                                                              * @return   This function returns non-zero
                                                                              *if user space is safe
                                                                              *
                                                                              ******************************************************************************/
