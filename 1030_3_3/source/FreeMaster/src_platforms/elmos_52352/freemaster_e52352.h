...
#ifndef __FREEMASTER_E52352_H
#define __FREEMASTER_E52352_H
...
#define FMSTR_IDT_STRING "E52352 FreeMASTER"
#define FMSTR_TSA_FLAGS 1
...
#define FMSTR_SETREG8(base, offset, value) (*(volatile FMSTR_U8 *)(((FMSTR_U16)(base)) + (offset)) = value)
#define FMSTR_GETREG8(base, offset) (*(volatile FMSTR_U8 *)(((FMSTR_U16)(base)) + (offset)))
#define FMSTR_SETBIT8(base, offset, bit) (*(volatile FMSTR_U8 *)(((FMSTR_U16)(base)) + (offset)) |= bit)
#define FMSTR_CLRBIT8(base, offset, bit)                                                                               \
  (*(volatile FMSTR_U8 *)(((FMSTR_U16)(base)) + (offset)) &= (FMSTR_U8) ~((FMSTR_U8)(bit)))
#define FMSTR_SETREG16(base, offset, value) (*(volatile FMSTR_U16 *)(((FMSTR_U16)(base)) + (offset)) = value)
#define FMSTR_GETREG16(base, offset) (*(volatile FMSTR_U16 *)(((FMSTR_U16)(base)) + (offset)))
#define FMSTR_SETBIT16(base, offset, bit) (*(volatile FMSTR_U16 *)(((FMSTR_U16)(base)) + (offset)) |= bit)
#define FMSTR_CLRBIT16(base, offset, bit)                                                                              \
  (*(volatile FMSTR_U16 *)(((FMSTR_U16)(base)) + (offset)) &= (FMSTR_U16) ~((FMSTR_U16)(bit)))
#define FMSTR_TSTBIT16(base, offset, bit) (*(volatile FMSTR_U16 *)(((FMSTR_U16)(base)) + (offset)) & (bit))
#define FMSTR_SETREG32(base, offset, value) (*(volatile FMSTR_U32 *)(((FMSTR_U16)(base)) + (offset)) = value)
#define FMSTR_GETREG32(base, offset) (*(volatile FMSTR_U32 *)(((FMSTR_U16)(base)) + (offset)))
#define FMSTR_SETBIT32(base, offset, bit) ((*(volatile FMSTR_U32 *)(((FMSTR_U16)(base)) + (offset))) |= bit)
#define FMSTR_CLRBIT32(base, offset, bit) ((*(volatile FMSTR_U32 *)(((FMSTR_U16)(base)) + (offset))) &= ~(bit))
#define FMSTR_TSTBIT32(base, offset, bit) (*(volatile FMSTR_U32 *)(((FMSTR_U16)(base)) + (offset)) & (bit))

/****************************************************************************************
 * SCI module constants
 *****************************************************************************************/
/* SCI registers */
#define FMSTR_SCI_CONTROL_OFFSET 0x02
#define FMSTR_SCI_STATUS_OFFSET 0x04
#define FMSTR_SCI_DATA_OFFSET 0x06

/* SCI Control registers bits */
#define FMSTR_SCI_CONTROL_TE (1 << 3)
#define FMSTR_SCI_CONTROL_RE (1 << 2)
#define FMSTR_SCI_CONTROL_TIE (1 << 7)
#define FMSTR_SCI_CONTROL_RIE (1 << 5)

/* SCI Status registers bits */
#define FMSTR_SCISR_TDRE (1 << 7) // transmit data register empty
#define FMSTR_SCISR_TC (1 << 6)   // transmit complete flag
#define FMSTR_SCISR_RDRF (1 << 5) // receive data register full flag
#define FMSTR_SCISR_OR (1 << 3)   // receiver overrun detected
...
#define FMSTR_SCI_RDCLRSR()                                                                                            \
  (FMSTR_GETREG32(FMSTR_SCI_BASE, FMSTR_SCISTATUS_OFFSET) >> 16);                                                      \
  FMSTR_SETREG32(FMSTR_SCI_BASE, FMSTR_SCISTATUS_OFFSET, FMSTR_GETREG32(FMSTR_SCI_BASE, FMSTR_SCISTATUS_OFFSET));

#else

/* transmitter enable/disable */
#define FMSTR_SCI_TE() FMSTR_SETBIT16(FMSTR_SCI_BASE, FMSTR_SCI_CONTROL_OFFSET, FMSTR_SCI_CONTROL_TE)
#define FMSTR_SCI_TD() FMSTR_CLRBIT16(FMSTR_SCI_BASE, FMSTR_SCI_CONTROL_OFFSET, FMSTR_SCI_CONTROL_TE)

/* receiver enable/disable */
#define FMSTR_SCI_RE() FMSTR_SETBIT16(FMSTR_SCI_BASE, FMSTR_SCI_CONTROL_OFFSET, FMSTR_SCI_CONTROL_RE)
#define FMSTR_SCI_RD() FMSTR_CLRBIT16(FMSTR_SCI_BASE, FMSTR_SCI_CONTROL_OFFSET, FMSTR_SCI_CONTROL_RE)

#define FMSTR_SCI_TE_RE()                                                                                              \
  FMSTR_SETBIT16(FMSTR_SCI_BASE, FMSTR_SCI_CONTROL_OFFSET, FMSTR_SCI_CONTROL_TE | FMSTR_SCI_CONTROL_RE)

/* Transmitter-empty interrupt enable/disable */
#define FMSTR_SCI_ETXI() sci_enable_irq(SCI, SCI_IRQ_TRANSMIT, true)
#define FMSTR_SCI_DTXI() sci_enable_irq(SCI, SCI_IRQ_TRANSMIT, false)

/* Receiver-full interrupt enable/disable */
#define FMSTR_SCI_ERXI() sci_enable_irq(SCI, SCI_IRQ_RECEIVE, true)
#define FMSTR_SCI_DRXI() sci_enable_irq(SCI, SCI_IRQ_RECEIVE, false)

/* Tranmsit character */
#define FMSTR_SCI_PUTCHAR(ch) FMSTR_SETREG16(FMSTR_SCI_BASE, FMSTR_SCI_DATA_OFFSET, ch)

/* Get received character */
#define FMSTR_SCI_GETCHAR() ((FMSTR_GETREG16(FMSTR_SCI_BASE, FMSTR_SCI_DATA_OFFSET)) & 0xFF)

/* read status register */
#define FMSTR_SCI_GETSR() FMSTR_GETREG16(FMSTR_SCI_BASE, FMSTR_SCI_STATUS_OFFSET)

/* read & clear status register */
#if FMSTR_SCI_STATUS_W1C
#define FMSTR_SCI_RDCLRSR() 0
#else
#define FMSTR_SCI_RDCLRSR() FMSTR_GETREG16(FMSTR_SCI_BASE, FMSTR_SCI_STATUS_OFFSET)
#endif
...
#define FMSTR_FCAN_GET_MBSTATUS()                                                                                      \
  (FMSTR_GETREG8(FMSTR_CAN_BASE, FMSTR_FCANTXFG_OFFSET + FMSTR_FCMBCSR + 3) & FMSTR_FCANMB_CODE_MASK)

/* FCAN: id to idr translation */
#define FMSTR_FCAN_MAKEIDR0(id)                                                                                        \
  ((FMSTR_U8)(((id)&FMSTR_CAN_EXTID) ? ((((id) >> 24) & 0x1f) | FMSTR_FCANID0_EXT_FLG) : (((id) >> 6) & 0x1f)))
...
#define FMSTR_FCAN_RINIT(idr0, idr1, idr2, idr3)                                                                       \
  ...
  (((idr0)&FMSTR_FCANID0_EXT_FLG)                                                                                      \
     ? (FMSTR_SETREG16(FMSTR_CAN_BASE, FMSTR_FCANRXFG_OFFSET + FMSTR_FCMBCSR + 2,                                      \
                       (FMSTR_FCANMB_CRXVOID << 8 | FMSTR_FCANCTRL_IDE | FMSTR_FCANCTRL_EXT_SRR)))                     \
     : (FMSTR_SETREG16(FMSTR_CAN_BASE, FMSTR_FCANRXFG_OFFSET + FMSTR_FCMBCSR + 2,                                      \
                       (FMSTR_FCANMB_CRXVOID << 8 | FMSTR_FCANCTRL_EXT_SRR))));                                        \
  FMSTR_SETREG32(FMSTR_CAN_BASE, FMSTR_FCANRXFG_OFFSET + FMSTR_FCMBIDR0,                                               \
                 ((idr0) << 24) | ((idr1) << 16) | ((idr2) << 8) | (idr3));                                            \
  FMSTR_MACROCODE_END()
...
#define FMSTR_FCAN_TINIT(idr0, idr1, idr2, idr3)                                                                       \
  FMSTR_MACROCODE_BEGIN()                                                                                              \
  (((idr0)&FMSTR_FCANID0_EXT_FLG)                                                                                      \
     ? (FMSTR_SETREG16(FMSTR_CAN_BASE, FMSTR_FCANTXFG_OFFSET + FMSTR_FCMBCSR + 2,                                      \
                       (FMSTR_FCANMB_CTXREADY << 8 | FMSTR_FCANCTRL_IDE)))                                             \
...
#define FMSTR_FCAN_TLEN(pctx, len)                                                                                     \
  FMSTR_SETREG8(FMSTR_CAN_BASE, FMSTR_FCANTXFG_OFFSET + FMSTR_FCMBCSR + 2,                                             \
                (FMSTR_U8)((len & 0x0f) | (FMSTR_GETREG8(FMSTR_CAN_BASE, FMSTR_FCANTXFG_OFFSET + FMSTR_FCMBCSR + 2) &  \
                                           (FMSTR_FCANCTRL_IDE | FMSTR_FCANCTRL_EXT_SRR | FMSTR_FCANCTRL_EXT_RTR))))

/* FCAN transmission, put one data byte into buffer */
#define FMSTR_FCAN_PUTBYTE(pctx, dataByte)                                                                             \
  FMSTR_MACROCODE_BEGIN()                                                                                              \
  FMSTR_SETREG8(FMSTR_CAN_BASE,                                                                                        \
                (FMSTR_FCANTXFG_OFFSET + FMSTR_FCMBDSR0) - (0x3 & ((pctx)->nDataIx)) + (0x4 & ((pctx)->nDataIx)),      \
                (dataByte));                                                                                           \
  (pctx)->nDataIx++;                                                                                                   \
  FMSTR_MACROCODE_END()
...
#define FMSTR_FCAN_TID(pctx, idr0, idr1, idr2, idr3)                                                                   \
  FMSTR_MACROCODE_BEGIN()                                                                                              \
  FMSTR_SETREG32(FMSTR_CAN_BASE, FMSTR_FCANTXFG_OFFSET + FMSTR_FCMBIDR0,                                               \
                 ((idr0) << 24) | ((idr1) << 16) | ((idr2) << 8) | (idr3));                                            \
  FMSTR_MACROCODE_END()
...
#define FMSTR_FCAN_TEST_RIDR(pctx, idr0, idr1, idr2, idr3)                                                             \
  ((idr0 & FMSTR_FCANID0_EXT_FLG) ? /* ext id compare */                                                               \
     (((((idr0) << 24) | ((idr1) << 16) | ((idr2) << 8) | (idr3)) & 0x1f000000) ==                                     \
      ((FMSTR_GETREG32(FMSTR_CAN_BASE, FMSTR_FCANRXFG_OFFSET + FMSTR_FCMBIDR0)) & 0x1f000000))                         \
                                  : /* std id compare */                                                               \
     ((((idr0) << 8) | (idr1)) ==                                                                                      \
      ((FMSTR_GETREG16(FMSTR_CAN_BASE, FMSTR_FCANRXFG_OFFSET + FMSTR_FCMBIDR0 + 2)) & 0x1ffc)))
...
#define FMSTR_FCAN_GETBYTE(pctx)                                                                                       \
  ((FMSTR_U8)(FMSTR_GETREG8(FMSTR_CAN_BASE, (FMSTR_FCANRXFG_OFFSET + FMSTR_FCMBDSR0) - (0x3 & ((pctx)->nDataIx)) +     \
                                              (0x4 & ((pctx)->nDataIx)))));                                            \
  (pctx)->nDataIx++
