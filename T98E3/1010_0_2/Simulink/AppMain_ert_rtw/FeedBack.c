...
#define IN_NO_ACTIVE_CHILD_po33        ((uint8_T)0U)
...
void FeedBack_Init(void)
{
  ...
  DW.is_c3_AppMain = IN_NO_ACTIVE_CHILD_po33;
...
void FeedBack(void)
{
   ...
   */
  rtb_DataTypeConversion1 = FeedBackDelay(0, ((int32_T)B.Status_jbt3 > 0), 0,
  ...
  rtb_LogicalOperator3_ew35 = ((U.IsMotorOpenLoad &&
    DW.FeedBackEnLast_PreviousInp_nnxg) || ((int32_T)Y.OpenCnt >= 15));
  ...
  rtb_LogicalOperator3_j3fr = ((U.IsMotorLock &&
    DW.FeedBackEnLast_PreviousInp_by2c) || ((int32_T)Y.LockCnt >= 15));
