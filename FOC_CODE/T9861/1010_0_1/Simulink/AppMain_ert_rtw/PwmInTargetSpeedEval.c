 ...
 * C/C++ source code generated on : Wed Nov 13 11:17:44 2024
 *
...
boolean_T FreqValidJudge(uint16_T rtu_Freq, DW_FreqValidJudge_T *localDW)
{
  ...
  else if ((int32_T)localDW->InvalidCnt >= 6)
  {
    /* Transition: (':1737:28') */
    localDW->is_c12_AppMain = IN_Invalid;
...
void PwmInNotShort(void)
{
  ...
  /* Logic: 'Logical Operator1' (':3250') incorporates:
   *  Inport: 'PwmInCaptureEn' (':3255')
   */
  rtb_UpdateFlag = (rtb_Valid && U.PwmInCaptureEn);

  /* Outputs for Enabled SubSystem: 'DutyFilter' (':1703') */
  /* SignalConversion generated from: 'Enable' (':1706') */
  DutyFilter(rtb_UpdateFlag, B.HighDuty, B.DutyLast, B.Compare, &B.Switch,
...
void PwmInTargetSpeedEval(void)
{
  ...
  rtAction = (int8_T)((int32_T)DW.PowerOnBlankTimeCnt_PreviousInp >= 8);
