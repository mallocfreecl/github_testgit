...
void SDK_BDRV_TestMos(u8 state)
{
    switch(state)
    {
      ...
      case 1u:
      {
        CCU6->MODCTR.reg = (u16)(0x80u | 0x03u);
        CCU6->MCMOUTS.reg = (u16)(0x0Bu | CCU6_MASK_MCMOUTS_SHADOW_OUT);
      }  
      break;
      case 2u:
      {
        CCU6->MODCTR.reg = (u16)(0x80u | 0x30u);
        CCU6->MCMOUTS.reg = (u16)(0x32u | CCU6_MASK_MCMOUTS_SHADOW_OUT);
      }
      break;
      case 3:
      {
        CCU6->MODCTR.reg = (u16)(0x80u | 0x0Cu);
        CCU6->MCMOUTS.reg = (u16)(0x2Cu | CCU6_MASK_MCMOUTS_SHADOW_OUT);
      }
      break;
      default:
        BDRV_Set_Bridge(Ch_Off, Ch_Off, Ch_Off, Ch_Off, Ch_Off, Ch_Off);
