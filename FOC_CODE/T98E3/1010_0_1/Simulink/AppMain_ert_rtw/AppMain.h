...
typedef struct
{
  ...
  int8_T Status;                       /* 'AmbTPreOverDiag' (':2333') */
  int8_T Status_ila3;                  /* 'VoltageDiag' (':1620') */
  int8_T Status_jbt3;                  /* 'AmbTOverDiag' (':1621') */
...
typedef struct
{
  ...
  DW_AmbTOverDiag_T sf_AmbTPreOverDiag;/* 'AmbTOverDiag' (':1621') */
 ...
 * Block synthesized block : Unused code path elimination
 * Block synthesized block : Unused code path elimination
 * Block 'Manual Switch' (':3107') : Eliminated due to constant selection input
