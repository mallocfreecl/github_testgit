...
#ifndef FREEMASTER_DEFCFG_H
#define FREEMASTER_DEFCFG_H
...
#if defined(FMSTR_SCI_BASE) && !FMSTR_USE_ESCI && !FMSTR_USE_LPUART && !FMSTR_USE_JTAG && !FMSTR_USE_CAN &&            \
  !FMSTR_USE_MQX_IO && !FMSTR_USE_USB_CDC && !FMSTR_DISABLE && !FMSTR_USE_PDBDM && !FMSTR_USE_MBED
